  ...
  const allApps = [
    {
      ...
      image:
        "https://seeklogo.com/images/X/xampp-logo-1C1A9E3689-seeklogo.com.png",
    },
    {
      id: "netbeans",
      name: "Netbeans",
      ...
      mataKuliah: "Pemrograman Web",
      image:
        "https://i0.wp.com/gluonhq.com/wp-content/uploads/2015/09/netbeans-logo-21.png?fit=224%2C224&ssl=1",
    },
    {
      id: "figma",
      name: "Figma",
      programStudi: "Sistem Informasi",
      mataKuliah: "Perancangan User Experience",
      image:
    ...
    },
    {
      ...
      image:
        "https://play-lh.googleusercontent.com/eWYNxjXiub6-HqtwoS2d4bl-NkqcKgOHansSnXXqje8-K9XLRwflOgEYwSzPMicdAA=w480-h960-rw",
    },
    {
      id: "wpsoffice",
      name: "WPS Office",
      ...
      mataKuliah: "Literasi Digital",
      image:
        "https://play-lh.googleusercontent.com/DUohbTj-FKR_48Dav1c-1QZTSo6D0CzVNSO28RYhC2AH8_3B93AO3lTF3S2PKPQHeQY=s96-rw",
    },
  ];
  ...
  const handleFilterApps = (ps, mk) => {
    if (ps || mk) {
      const filtered = allApps.filter(
        (app) =>
          (ps ? app.programStudi === ps : true) &&
          (mk ? app.mataKuliah === mk : true)
      );
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>
            ...
            <Text style={styles.perkuliahan}>Perkuliahan</Text>
          </Text>
        ...
        <View style={styles.dropdownContainer}>
          ...
          >
            ...
            <Picker.Item
              label="Perancangan User Experience"
              value="Perancangan User Experience"
            />
            <Picker.Item label="Literasi Digital" value="Literasi Digital" />
          </Picker>

          <TextInput placeholder="Cari Aplikasi" style={styles.searchBox} />
        </View>
